...
import { getAntThemeConfig } from './antThemeConfig.ts';
import { isVscodeDarkTheme, observeVscodeThemeChange } from './util/vscodeTheme.ts';
import ViewerState from './view/components/ViewerState.tsx';
...
function Root() {
  ...
  return (
    ...
    >
      <Suspense fallback={<ViewerState kind='loading' />}>
        <App />
      </Suspense>
    </ConfigProvider>
  )
