...
export default function GitHistory({ desktopInit }: { desktopInit?: GitHistoryInitPayload } = {}) {
...
function GitHistoryView({
    ...
    desktopInit?: GitHistoryInitPayload;
    ...
    useEffect(() => {
        ...
        const embeddedInit = desktopInit
            ?? getConfigs()?.gitHistoryInit as GitHistoryInitPayload | undefined;
    ...
    }, [applyCommitsData, clearCommitList, completeExecution, desktopInit, runNextBatchAction, syncRelPath]);
