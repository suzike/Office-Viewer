...
import { getEditorRange, getSelectionRangeInEditor, setSelectionFocus } from "../util/selection";
...
const getFocusedCell = (_vditor: IVditor, editor: HTMLElement): HTMLTableCellElement | null => {
    // Theme changes can resize tables while the user is operating the toolbar.
    // Inspect the selection without creating a fallback range that steals focus.
